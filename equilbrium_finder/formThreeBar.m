function [nodes, cable_pairs, bar_pairs] = formThreeBar(edge_length, ...
...
%   nodes: matrix of x,y,z, position of nodes based on design parameters
...
% Bars by pairs of node indices           
bar_pairs   = [1 6;     % bar 10
               2 4;     % bar 11
               3 5];    % bar 12